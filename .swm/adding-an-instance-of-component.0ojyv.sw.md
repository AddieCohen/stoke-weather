...
Understanding a comp exs and how they work is an important part of contributing to our system.

This document will describe all you need to know about a comp exs.

A a comp ex is {add a high-level description of Components are and their role in the system}.

Some examples of a comp exs are: {add examples here}
...
Every a comp ex should define these at the class level:
...
Every time we add a new a comp ex, we reference it in a few locations:
...
In this example we can see how our new a comp ex can be used:
...
This file was generated by Swimm. [Click here to view it in the app](http://localhost:5000/repos/Z2l0aHViJTNBJTNBc3Rva2Utd2VhdGhlciUzQSUzQUFkZGllQ29oZW4=/docs/0ojyv).