...
file_blobs:
  ...
  src/features/search-bar/search-bar.tsx: 40aa34fdc59a77ab74dfbd316132d719859aa058
...
`keyDownHandler`[<sup id="Z2sLTiG">↓</sup>](#f-Z2sLTiG) is a function here
<!-- NOTE-swimm-snippet: the lines below link your snippet to Swimm -->
...
⬜ 10     
🟩 11         const keyDownHandler = (event: any) => {
...
<span id="f-Z2sLTiG">keyDownHandler</span>[^](#Z2sLTiG) - "src/features/search-bar/search-bar.tsx" L11
```tsx
...
This file was generated by Swimm. [Click here to view it in the app](https://swimm.io/link?l=c3dpbW0lM0ElMkYlMkZyZXBvcyUyRloybDBhSFZpSlROQkpUTkJjM1J2YTJVdGQyVmhkR2hsY2lVelFTVXpRVUZrWkdsbFEyOW9aVzQlM0QlMkZkb2NzJTJGUEl2M3A=).